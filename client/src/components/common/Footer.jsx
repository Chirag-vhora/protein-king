export default function Footer() {
  return (
    <footer className="bg-surface-dim border-t border-white/10 w-full mt-10 md:mt-20 relative z-20">
      <div className="flex flex-col items-center py-10 md:py-16 px-4 md:px-16 gap-8 max-w-[1280px] mx-auto">
